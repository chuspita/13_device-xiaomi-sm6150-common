...
TARGET_KERNEL_ADDITIONAL_FLAGS := AS=llvm-as NM=llvm-nm OBJCOPY=llvm-objcopy OBJDUMP=llvm-objdump STRIP=llvm-strip LD=ld.lld LLVM=1 LLVM_IAS=1
TARGET_KERNEL_CLANG_COMPILE := true
#KERNEL_SUPPORTS_LLVM_TOOLS := true
TARGET_KERNEL_SOURCE := kernel/xiaomi/perf
